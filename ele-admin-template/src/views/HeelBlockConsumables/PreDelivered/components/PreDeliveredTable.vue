<template>
  <div class="ele-body">
    <PreDeliveredTableSearch @search="reload" @Approve_btn="ApproveFun" @Delete_btn="DeleteFun" @Confirm_btn="ConfirmFun" :rowData="current" @exportData="exportData" />
    <!-- 数据表格 -->
    <ele-pro-table highlight-current-row @current-change="onCurrentChange" :row-class-name="tableRowClassName" ref="table" height="60vh" :rowClickChecked="true" :stripe="false" :pageSize="pageSize" :pageSizes="pageSizes" :columns="columns" :needPage="false" :datasource="datasource" :selection.sync="selection" cache-key="PreDeliveredTable">
      <!-- 表头工具栏 -->
...
<script>
import PreDeliveredTableSearch from './PreDeliveredTableSearch.vue';
import {
  SerachTempletList,
  DeleteTemplet,
  EditTempName
