  ...
  <el-form label-width="77px" class="ele-form-search" @keyup.enter.native="search" @submit.native.prevent>
    <el-row :gutter="15">
      <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
        <el-input size="mini" clearable v-model="where.VarPriceRecode_varScarch" placeholder="编码/名称/规格型号" />
      </el-col>
      ...
      <el-col v-bind="styleResponsive ? { lg: 4, md: 12 } : { span: 6 }">
        <label>
        处理状态:
          <el-select v-model="where.SPECIFICATION_OR_TYPE" size="mini" placeholder="请选择状态">
