        ...
        columns: [
          ...
          },
          {
            ...
            formatter: function (d) {
              return (
                d.SPD_COST_DEPT_ONE_NAME +
                '(' +
                d.SPD_COST_HERP_DEPT_ONE_CODE +
                ')'
              );
            }
          },
          ...
          },
          {
            ...
            formatter: function (d) {
              ...
              if (
                Number(d.Supply_Price).toFixed(d.price_bl) !=
                Number(d.HIS_CHARGING_PRICE).toFixed(d.price_bl)
              ) {
                return (
          ...
          },
          {
            ...
            formatter: function (d) {
              ...
              if (
                ...
                return (
                  '<span style="color:red">' + d.HIS_CHARGING_PRICE + '</span>'
                );
              } else {
