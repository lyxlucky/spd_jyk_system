<template>
  <div class="snapshot-center-kz">
    <el-row :gutter="12">
      <el-col :span="8">
        <div class="panel-head">库存日志批次</div>
        ...
        >
          <el-table-column prop="ORDER_NUM" label="快照单号" min-width="120" show-overflow-tooltip />
          <el-table-column prop="CREATE_MAN" label="快照人" width="90" />
      ...
      <el-col :span="16">
        ...
        <el-form size="small" class="detail-filters" @submit.native.prevent>
          <el-row :gutter="8">
            <el-col :span="6">
              <el-input v-model="detailQuery.ortVar" clearable placeholder="品种编码/品种全称" />
            </el-col>
            <el-col :span="6">
              <el-input v-model="detailQuery.ortSup" clearable placeholder="供应商" />
            </el-col>
            <el-col :span="6">
              <el-input v-model="detailQuery.ortBatch" clearable placeholder="生产批号" />
            </el-col>
            <el-col :span="6">
              <el-input v-model="detailQuery.ortFlsx" clearable placeholder="分类属性" />
            </el-col>
          </el-row>
          <el-row :gutter="8" style="margin-top: 8px">
            <el-col :span="6">
              <el-input v-model="detailQuery.ortKfwz" clearable placeholder="库房位置" />
            </el-col>
            <el-col :span="6">
              <el-input v-model="detailQuery.ortScqy" clearable placeholder="生产企业" />
            </el-col>
            <el-col :span="4">
              <span class="lbl">所属区域:</span>
              <el-select v-model="detailQuery.ortSsqy" clearable placeholder="全部" style="width: 100%">
            ...
            <el-col :span="4">
              <span class="lbl">合同到期:</span>
              <el-select v-model="detailQuery.ortHtdq" clearable placeholder="全部" style="width: 100%">
                <el-option label="全部" value="" />
        ...
        >
          ...
          <el-table-column prop="DEF_DOWN_SHELF_QTY" label="定数包未上架" width="90" align="center" />
          <el-table-column prop="GOODS_DOWN_SHELF_QTY" label="散货未上架" width="80" align="center" />
          <el-table-column prop="GOODS_LOOK_QTY" label="散货锁定" width="75" align="center" />
          <el-table-column prop="DEF_LOCKING_QTY" label="定数包锁定" width="85" align="center" />
          <el-table-column prop="PRE_LOCK_SUM" label="定数包预锁" width="85" align="center" />
          <el-table-column prop="BATCH_ID" label="批次号ID" width="70" />
          <el-table-column prop="POSITION" label="货位号" width="55" />
