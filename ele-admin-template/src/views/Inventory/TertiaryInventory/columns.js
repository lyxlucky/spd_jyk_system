...
export function getTertiaryInventoryColumns() {
  return [
    ...
    { prop: 'DEPT_TWO_NAME', label: '科室名称', width: 150, align: 'center',showOverflowTooltip: true },
    { prop: 'VARIETIE_CODE_NEW', label: '品种编码', width: 150,align: 'center', showOverflowTooltip: true },
    { prop: 'CHARGING_CODE', label: '计费编码', width: 150,align: 'center', showOverflowTooltip: true },
    { prop: 'VARIETIE_NAME', label: '品种名称', width: 300,align: 'center', showOverflowTooltip: true },
    { prop: 'SPECIFICATION_OR_TYPE', label: '规格型号', width: 250,align: 'center', showOverflowTooltip: true },
    { prop: 'COUNT', label: '数量', width: 150, align: 'center', showOverflowTooltip: true },
    ...
    { prop: 'MANUFACTURING_ENT_NAME', label: '生产企业', width: 300, align: 'center', showOverflowTooltip: true },
    { columnKey: 'action', label: '操作', width: 100, align: 'center', slot: 'action', className: 'action-col' }
  ];
}
