  ...
  <div class="search-container">
    ...
    <el-row :gutter="15">
      ...
      <el-col v-bind="styleResponsive ? { lg: 4, md: 12 } : { span: 6 }">
        <label class="el-label--inline">
          高低值分类下级分类:
          <el-select v-model="where.highOrLowClassTwo" size="mini" placeholder="全部" clearable style="width: 140px;">
            <el-option label="全部" value="-1"></el-option>
      ...
      <el-col v-bind="styleResponsive ? { lg: 4, md: 12 } : { span: 6 }">
        <label class="el-label--inline">
          设备科是否修改:
          <el-select v-model="where.change" size="mini" placeholder="全部" clearable style="width: 140px;">
            <el-option label="全部" value="-1"></el-option>
            <el-option label="否" value="0"></el-option>
            <el-option label="是" value="1"></el-option>
          </el-select>
       ...
       <el-row :gutter="15">
         <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
           <el-input size="mini" clearable v-model="where.searchinplt1" placeholder="请输入/品种编码/品种全称" />
         </el-col>
         <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
           <el-input size="mini" clearable v-model="where.cwj_searchinplt6" placeholder="请输入规格型号" />
         </el-col>
         <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
           <el-input size="mini" clearable v-model="where.searchinplt2" placeholder="科室/供应商名称" />
         </el-col>
         <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
           <el-input size="mini" clearable v-model="where.searchinplt3" placeholder="请输入生产批号" />
         </el-col>
         <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
           <el-input size="mini" clearable v-model="where.searchinplt4" placeholder="请输入入库类型" />
         </el-col>
         <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
           <el-input size="mini" clearable v-model="where.searchinplt5" placeholder="入库单号" />
         </el-col>
         <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
           <el-input size="mini" clearable v-model="where.searchinplt7" placeholder="生产企业" />
         </el-col>
       </el-row>
       <el-row :gutter="15">
         ...
         <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
           <el-input size="mini" clearable v-model="where.cwj_hinpPREPARE_GOODS_PLAN_NUMBER" placeholder="备货单号" />
         </el-col>
