    ...
    <div class="spd-panel__body">
      <el-form size="mini" :inline="true" @keyup.enter.native="search" @submit.native.prevent>
        ...
        <el-form-item label="品种">
          <el-input v-model="where.xsearchinplt1" clearable placeholder="规格/编码/全称" style="width: 150px" />
        </el-form-item>
        <el-form-item label="科室/供应商">
          <el-input v-model="where.xsearchinplt2" clearable placeholder="名称" style="width: 120px" />
        </el-form-item>
        <el-form-item label="生产批号">
          <el-input v-model="where.xsearchinplt3" clearable placeholder="生产批号" style="width: 100px" />
        </el-form-item>
        <el-form-item label="出库类型">
          <el-input v-model="where.xsearchinplt4" clearable placeholder="出库类型" style="width: 100px" />
        </el-form-item>
        <el-form-item label="出库单号">
          <el-input v-model="where.xsearchinplt5" clearable placeholder="出库单号" style="width: 110px" />
        </el-form-item>
        <el-form-item label="生产企业">
          <el-input v-model="where.xsearchinplt6" clearable placeholder="生产企业" style="width: 110px" />
        </el-form-item>
        <br />
