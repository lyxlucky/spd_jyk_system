      ...
      columns: [
        ...
        },
        {
          ...
          formatter: (row) => {
            ...
            var this_date = new Date(bvp_date).getTime();
            var this_dateDET_CONTRACT_END = new Date(bvp_dateDET_CONTRACT_END).getTime();
            var nowDate = new Date().getTime();
            if (this_date <= nowDate) {
          ...
          formatter: (row) => {
            ...
            if (this_dateDET_CONTRACT_END <= nowDate) {
              ...
              return `${row.DET_CONTRACT_END.substr(0, 10)}|${parseInt(((this_dateDET_CONTRACT_END - nowDate) / (60 * 60 * 24 * 1000)).toFixed(0))}天`;
            }
          }
        },
        {
        ...
        },
        {
          ...
          formatter: (row) => {
            ...
            return parseInt(((this_date - plan_date) / (60 * 60 * 24 * 1000)).toFixed(0)) + "天";
          }
        },
        {
          label: '备货计划单号',
