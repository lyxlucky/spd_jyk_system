  ...
  data() {
    return {
      ...
      mainColumns: [
        ...
        { label: '库房名称', prop: 'DIY_STORAGE', width: 80 },
        { label: '备注', width: 80, align: 'center', slot: 'remark' },
        { label: '备货数量', width: 90, align: 'center', slot: 'planQty' },
        { label: '是否常备', width: 80, align: 'center', slot: 'isCgBh' },
        { label: '阳光编码', prop: 'YG_CODE', width: 100 },
        ...
        { label: '注册证号', prop: 'APPROVAL_NUMBER', width: 100 },
        { label: '启用合同供应商', prop: 'SUPPLIER_NAME', minWidth: 160 },
        { label: '合同结束日期', prop: 'CONTRACT_END_TIME', width: 100 },
        { label: '合同明细结束日期', prop: 'DET_CONTRACT_END', width: 110 },
        { label: '近三个月用量', prop: 'USED_QTY', width: 90, align: 'right' },
        { label: '月均用量', prop: 'YUE_USED_QTY', width: 80, align: 'right' },
        { label: '周均用量', prop: 'ZHOU_USED_QTY', width: 80, align: 'right' },
        { label: '中心库存量', width: 80, align: 'right', slot: 'centerQty' },
        { label: '中心%', width: 70, align: 'right', slot: 'centerPct' },
        { label: '二级库存量', prop: 'DEPT_NUM', width: 80, align: 'right' },
        { label: '二级%', width: 70, align: 'right', slot: 'deptPct' },
        { label: '库存上限', prop: 'STOREHOUSE_UPPPER', width: 80, align: 'right' },
        { label: '库存下限', width: 80, align: 'right', slot: 'lower' },
        { label: '中包装数', prop: 'MIDDLE_PACKAGE_COUNT', width: 70, align: 'right' },
        { label: '中包装单位', prop: 'MIDDLE_PACKAGE_UNIT', width: 80, align: 'right' },
        { label: '大包装数', prop: 'BIG_BOX_COUNT', width: 70, align: 'right' },
        { label: '大包装单位', prop: 'BIG_BOX_UNIT', width: 80, align: 'right' },
        { label: '未到货最后一次下计划数量', prop: 'STOCK_UP_PLAN_GOODS_QUANTITY', width: 120, align: 'right' },
        { label: '未到货最后一次下计划时间', width: 120, slot: 'planTime' },
        { label: '发送状态', width: 110, slot: 'sendState' },
        { label: '操作', width: 110, fixed: 'right', slot: 'action' }
      ],
      pickingColumns: [
        { label: '备货计划单号', prop: 'Stock_Up_Plan_No', width: 120 },
        { label: '创建人', prop: 'Creator', width: 80 },
        { label: '供应商名称', prop: 'supplier_name', minWidth: 120 },
        { label: '收货院区', prop: 'NAME', width: 80 },
        { label: '创建时间', width: 150, slot: 'createTime' },
        { label: '备注', width: 70, align: 'center', slot: 'planRemark' },
        { label: '审批状态', width: 90, slot: 'approveState' },
      ...
      detailColumns: [
        ...
        { label: '生产企业', prop: 'Manufacturing_Ent_Name', width: 110 },
        { label: '价格', width: 70, align: 'right', slot: 'price' },
        { label: '系数', prop: 'Coefficient', width: 55, align: 'center' },
        { label: '备货/包', prop: 'Stock_Up_Plan_Def_Quantity', width: 80, align: 'center' },
        { label: '备货/散', prop: 'Stock_Up_Plan_Goods_Quantity', width: 80, align: 'center' },
        { label: '实收数量', prop: 'ReceiptQty', width: 80, align: 'center' },
