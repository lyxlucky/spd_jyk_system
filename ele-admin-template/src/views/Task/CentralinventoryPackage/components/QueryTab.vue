  ...
  data() {
    ...
    return {
      ...
      columns: [
        ...
        { prop: 'Varietie_Name', label: '品种全称', minWidth: 180 ,align: 'center'},
        { prop: 'Specification_Or_Type', label: '型号/规格', minWidth: 140 ,align: 'center'},
        { prop: 'Unit', label: '单位', width: 80, align: 'center' },
        { prop: 'Manufacturing_Ent_Name', label: '生产企业名称', minWidth: 140 ,align: 'center'},
        { prop: 'Batch', label: '生产批号', width: 120, sortable: true },
        { columnKey: 'bagTime', label: '制包时间', width: 140, slot: 'bagTime', sortable: true },
        { columnKey: 'prodDate', label: '生产日期', width: 120, slot: 'prodDate', sortable: true },
        { columnKey: 'validDate', label: '失效日期', width: 120, slot: 'validDate', sortable: true },
        { prop: 'Coefficient', label: '系数', width: 80, align: 'center', sortable: true },
        { prop: 'Def_No_Pkg_Code', label: '定数码', width: 130, sortable: true },
        { prop: 'PRINT_COUNT', label: '打印次数', width: 120, sortable: true },
        { prop: 'Serial_Number', label: 'UDI码', width: 120, sortable: true },
        { prop: 'RFID_Code', label: 'RFID码', width: 120, sortable: true },
        { columnKey: 'printState', label: '打印上架状态', width: 160, slot: 'printState', sortable: true },
