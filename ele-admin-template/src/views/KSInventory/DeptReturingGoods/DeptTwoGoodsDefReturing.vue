        ...
        <div class="spd-panel spd-table-panel">
          <div class="spd-panel__head spd-panel__head--split">
            ...
            <span class="panel-actions">
              <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleCreate()">创建退货单</el-button>
              <el-button
                type="success"
                icon="el-icon-check"
                size="mini"
          ...
          <div class="spd-table-panel__wrap">
            <ele-pro-table
              ...
              cache-key="DeptTwoGoodsDefReturingLeftTable"
        ...
        <div class="spd-panel spd-table-panel">
          ...
          <div class="spd-table-panel__wrap">
            <ele-pro-table
              ...
              cache-key="DeptTwoGoodsDefReturingRightTable"
    ...
    >
      <div class="dialog-content">
        ...
        <ele-pro-table
          ...
          cache-key="DeptTwoGoodsDefReturingInLineTable"
...
.dept-two-goods-def-returing >>> .el-table th .cell {
  white-space: nowrap;
}
