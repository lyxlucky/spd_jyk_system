  ...
  <el-form label-width="77px" class="ele-form-search" @keyup.enter.native="search" @submit.native.prevent>
    <el-row :gutter="10">
      <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
        <el-input size="mini" clearable v-model="where.varietie" placeholder="品种编码、品种全称" />
      </el-col>
      <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
        <el-input size="mini" clearable v-model="where.supplier" placeholder="请输入供应商搜索" />
      </el-col>
      <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
        <el-input size="mini" clearable v-model="where.manuEntName" placeholder="请输入生产企业搜索" />
      </el-col>
      <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
        <el-input size="mini" clearable v-model="where.batch" placeholder="请输入生产批号搜索" />
      </el-col>
      <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
        <el-input size="mini" clearable v-model="where.deptTwoName" placeholder="请输入科室名称" />
      </el-col>
      <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
        <el-input size="mini" clearable v-model="where.DEPT_NAME" placeholder="计费科室名称" />
      </el-col>
      <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
        <el-input size="mini" clearable v-model="where.SPDDEPTNAME" placeholder="成本科室名称" />
      </el-col>
    ...
    <el-row :gutter="10" style="margin-top:10px">
      ...
      <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
        <el-input size="mini" clearable v-model="where.trade" placeholder="请输入国产/进口" />
      </el-col>
      <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
        <el-input size="mini" clearable v-model="where.classificName" placeholder="请输入分类属性" />
      </el-col>
      <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
        <el-input size="mini" clearable v-model="where.specType" placeholder="请输入规格型号" />
      </el-col>
      <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
        <el-input size="mini" clearable v-model="where.Patient_Number" placeholder="病患号/住院号" />
      </el-col>
      <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
        <el-input size="mini" clearable v-model="where.def" placeholder="请输入定数码" />
      </el-col>
      <el-col v-bind="styleResponsive ? { lg: 3, md: 12 } : { span: 6 }">
        <el-input size="mini" clearable v-model="where.Operate_Person" placeholder="消耗人" />
      </el-col>
    ...
    <el-row :gutter="10" style="margin-top:0">
      ...
      <el-col v-bind="styleResponsive ? { lg: 4, md: 12 } : { span: 6 }">
        <el-date-picker size="mini" v-model="where.monthFmt" type="month" style="width:140px" value-format="yyyy-MM" placeholder="开始时间" :disabled="!where.useMonth">
        </el-date-picker>

        <el-date-picker size="mini" v-model="where.monthFmt2" type="month" style="width:140px;margin-left:10px" value-format="yyyy-MM" placeholder="结束时间" :disabled="!where.useMonth">
        </el-date-picker>
      </el-col>
