...
export function getConsumeColumns() {
  return [
    ...
    { prop: 'Dept_One_Name', label: '收货一级科室', minWidth: 90, showOverflowTooltip: true },
    { prop: 'Dept_Two_Name', label: '收货二级科室', minWidth: 90, sortable: 'custom', showOverflowTooltip: true },
    { prop: 'Dept_Name', label: '计费科室名称', minWidth: 100, showOverflowTooltip: true },
    { prop: 'JS_STORAGE_NAME', label: '结算科室', minWidth: 100, showOverflowTooltip: true },
    {
    ...
    { prop: 'CLASSIFIC_NAME2', label: '分类属性', minWidth: 90, sortable: 'custom', showOverflowTooltip: true },
    { prop: 'Varietie_Code_New', label: '品种编码', minWidth: 90, sortable: 'custom', showOverflowTooltip: true },
    ...
    { prop: 'XTMC', label: '产品系统名称', minWidth: 120, hidden: !isStzl, showOverflowTooltip: true },
    {
    ...
    { prop: 'Batch', label: '生产批号', minWidth: 90, sortable: 'custom' },
    {
    ...
    { prop: 'Coefficient', label: '系数', width: 55, align: 'center', sortable: 'custom' },
    ...
    { prop: 'CLASS_ONE', label: '一级目录', minWidth: 100, showOverflowTooltip: true },
    { prop: 'CLASS_TWO', label: '二级目录', minWidth: 100, showOverflowTooltip: true },
    { prop: 'CLASS_THREE', label: '三级目录', minWidth: 100, showOverflowTooltip: true },
    {
      label: '消耗方式',
      minWidth: 100,
      sortable: 'custom',
    ...
    { prop: 'Dept_Code', label: '计费科室编码', minWidth: 100 },
    {
    ...
    { prop: 'High_Or_Low_Class', label: '高低值', width: 65 },
    { prop: 'Trade_Type', label: '国产/进口', width: 75 },
    {
      prop: 'IS_CHARGE',
      label: '是否计费',
      width: 75,
    ...
    { prop: 'SEND_WXT_MARK', label: '微讯通结算月份', minWidth: 115 },
    {
      prop: 'Reverse_State',
      label: '是否允许逆向',
      width: 100,
    ...
    { prop: 'CHARGING_CODE', label: '计费编码', minWidth: 90 },
    ...
    { prop: 'MARK', label: '出库单备注', minWidth: 90, showOverflowTooltip: true },
    { prop: 'SOURCE_FROM', label: '阳光平台来源', width: 90 },
    {
      prop: 'IS_JC',
      label: '是否集采',
      width: 80,
    ...
    { prop: 'Mgmt_Cat_Name', label: '管理类别名称', minWidth: 100, showOverflowTooltip: true },
    { prop: 'Prod_Big_Class_Name', label: '产品大类名称', minWidth: 100, showOverflowTooltip: true },
    { prop: 'Regulatory_Cat_Name', label: '监管类别名称', minWidth: 100, showOverflowTooltip: true },
    { prop: 'MEDICAL_NAME', label: '医保通用名', minWidth: 100, showOverflowTooltip: true },
    { prop: 'HIGH_CLASS_XH', label: '高值重点治疗序号', width: 110 },
    {
      prop: 'SEND_UDI',
      label: '是否发送UDI',
      width: 95,
    ...
    { prop: 'YG_CODE', label: '阳光产品码', minWidth: 100, showOverflowTooltip: true },
    { prop: 'YG_ORDER_ID', label: '阳光订单号', minWidth: 100, showOverflowTooltip: true },
    { prop: 'YG_HOSPITAL_ID', label: '阳光订单明细', minWidth: 100, showOverflowTooltip: true },
    { prop: 'TB_PJ_NAME', label: '套包名称', minWidth: 120, showOverflowTooltip: true },
    { prop: 'BZ', label: '备注', minWidth: 80, showOverflowTooltip: true },
    { prop: 'HISBZ', label: '消耗备注', minWidth: 100, showOverflowTooltip: true },
