    ...
    <el-row :gutter="10">
      ...
      <el-col :lg="18" :md="12">
        <div class="ele-form-actions">
          ...
          <el-button type="success" size="small" @click="subToExamine" :disabled='!IsPutInListDeta'>审核申领单</el-button>
          <el-button type="primary" v-if="['stzl','stzx'].includes(HOME_HP)" size="small" @click="Approval" :disabled='!IsToExamine'>审批申领单</el-button>
