      ...
      <el-row :gutter="12">
        <el-col v-bind="styleResponsive ? { sm: 20 } : { span: 20 }">
          <el-form-item label="品种类别:" prop="CLASS_NUM">
            <el-select clearable class="ele-block" v-model="form.CLASS_NUM" placeholder="请选择类别">
              <el-option v-for="item in CLASS_NUM" :key="item.value" :label="item.label" :value="item.value">
              </el-option>
