<template>
  <div>
    ...
    <ele-modal :destroy-on-close="true" width="1400px" :centered="true" @open="reload" :visible="visible" :close-on-click-modal="true" custom-class="ele-dialog-form" title="品种列表" @update:visible="updateVisible">
      <div class="ele-body">
        <el-card shadow="never">
          <!-- 数据表格 -->
          <!-- :selection.sync="selection" -->
          <ele-pro-table ref="table" height="600px" :pageSize="pageSize" :pageSizes="pageSizes" :columns="columns" :datasource="datasource" :rowClickChecked="true" :rowClickCheckedIntelligent="false" @selection-change="onSelectionChange" cache-key="AddPlanItem" :selection.sync="selection">
            <!-- 表头 -->
            <template v-slot:toolbar>
              <el-form class="ele-form-search" @keyup.enter.native="search" @submit.native.prevent>
                <el-row>
                  ...
                  <el-col :span="3">
                    <el-form-item>
                      <el-input style="width: 90%;" clearable v-model="where.Varietie_Name" placeholder="编码/名称" />
                    </el-form-item>
                  </el-col>
                  ...
                  <el-col v-bind="styleResponsive ? { lg: 4, md: 4 } : { span: 6 }">
                    <div class="ele-form-actions">
                      ...
                      <el-button type="primary" :disabled="isAddEnable" class="ele-btn-icon" @click="addItem()">
                        添加
                      </el-button>
                    </div>
                  </el-col>
