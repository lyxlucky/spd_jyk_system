<template >
  <ele-modal width="1600px" :destroy-on-close="true" :visible="visible" :close-on-click-modal="true" custom-class="ele-dialog-form" title="中标目录" @update:visible="updateVisible">
    <div class="ele-body">
