...
<template>
  <div>
    <el-form class="ele-form-search">
      <el-row :gutter="10">
        <el-col :lg="3" :md="12">
          <el-input size="mini" v-model="where.HIS_ITEM_NUMBER" placeholder="物料编码" clearable />
        </el-col>

        <el-col :lg="3" :md="12">
          <el-input size="mini" v-model="where.HIS_ITEM_DESCRIPTION" placeholder="物料名称" clearable />
        </el-col>
