  ...
  data() {
    return {
      ...
      mainColumns: [
        ...
        { prop: 'SUPPLIER_CODE', label: '工银商编码', width: 130, showOverflowTooltip: true },
        { prop: 'PRICE', label: '价格', width: 80, align: 'right' },
        { prop: 'SUPPLY_PRICE', label: '供应价格', width: 120, align: 'right' },
        { prop: 'YG_ZH_COUNT', label: 'YG_ZH_COUNT', width: 160, align: 'center' },
        { prop: 'IS_SEND_YG', label: '是否发送阳光平台', width: 160, showOverflowTooltip: true },
        { prop: 'YG_HOSPITAL_ID', label: '阳光医院Id', width: 130, showOverflowTooltip: true },
        { prop: 'YG_ORDER_ID', label: '阳光订单Id', width: 130, showOverflowTooltip: true },
        { prop: 'MONTHLY_TIME', label: '月结日期', width: 130, showOverflowTooltip: true },
        { prop: 'MONTH_ID', label: '月结Id', width: 120, showOverflowTooltip: true },
        { prop: 'purchaseCount', label: '采购数量', width: 120, align: 'right' },
        { prop: 'YG_ORDER_DETAIL_ID', label: '阳光详情订单Id', width: 160, showOverflowTooltip: true },
        { prop: 'WAREHOUSE_COUNT', label: '仓库盘点', width: 120, align: 'right' },
        { prop: 'DISTRIBUTE_COUN', label: '分布计数', width: 120, align: 'right' }
      ],
      detailColumns: [
