  ...
  data() {
    return {
      ...
      columns: [
        ...
        { prop: 'YG_IS_CAN_SEND', label: '是否发送', width: 120, align: 'center', slot: 'YG_IS_CAN_SEND' },
        ...
        { prop: 'COMPANYIDPS', label: '配送商编码', width: 120, showOverflowTooltip: true },
        ...
        { prop: 'PRODUCTCODE', label: '医保编码（平台）', width: 160, showOverflowTooltip: true },
        { prop: 'NUMBERCODE', label: '医保编码后7位（平台）', width: 200, showOverflowTooltip: true },
        ...
        { prop: 'YG_SUP_CODE', label: 'SPD供应商阳光平台', width: 180, showOverflowTooltip: true },
        ...
        { prop: 'CON_SUPPLY_PRICE', label: 'SPD合同结算价格', width: 180, align: 'right' },
        { prop: 'YG_ZH_COUNT', label: '转换比基础资料', width: 150, align: 'center' },
        { prop: 'TJ_YG_ZH_COUNT', label: '推荐转换比', width: 120, align: 'center' },
        { prop: 'UNIT', label: 'SPD单位', width: 120, align: 'center' },
