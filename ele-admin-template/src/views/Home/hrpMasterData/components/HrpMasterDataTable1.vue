<template>
  <div>
    <el-card>
      ...
      <ele-pro-table size="mini" ref="table" height="550px" :columns="columns" highlight-current-row :datasource="datasource" @row-click="rowClick" :paging="false"></ele-pro-table>
    </el-card>
  </div>
</template>
