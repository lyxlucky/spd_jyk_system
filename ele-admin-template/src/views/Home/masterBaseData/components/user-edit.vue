...
<script>
  import {
    ApproveYBSpdMainsjLinesIface,
    BatchPushChargeItemToHis
    ...
    methods: {
      save() {
        this.$refs.form.validate((valid) => {
          ...
          this.handleApproveYBSpdMainsjLinesIface()
            .then(() => {
              this.handleBatchPushChargeItemToHis()
                .then(() => {})
                .finally(() => {
                  this.$emit('done');
                  loading.close();
      ...
      handleBatchPushChargeItemToHis() {
        return new Promise((resolve, reject) => {
          BatchPushChargeItemToHis({
            HEADER_IFACE_ID: this.form.HEADER_IFACE_ID
          })
            .then((res) => {
              resolve(res);
      ...
      handleApproveYBSpdMainsjLinesIface() {
        return new Promise((resolve, reject) => {
