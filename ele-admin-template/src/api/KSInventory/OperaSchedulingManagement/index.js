...
export async function GetNaxtDayApplyPlanMain(data) {
  ...
  const res = await request.post(
    '/DeptApplyPlan/GetNaxtDayApplyPlanMain',
    data3
  );
...
export async function GetNaxtDayApplyPlanMainVar(data) {
  ...
  var data3 = formdataify(data2);
  const res = await request.post(
    '/DeptApplyPlan/GetNaxtDayApplyPlanMainVar',
    data3
  );
  if (res.data.code == 200) {
    return res.data;
...
export async function AddNaxtDayApplyPlanMain(data) {
  ...
  data2.SURGICAL_SCHEDULING_ID = data.SURGICAL_SCHEDULING_ID
    ? data.SURGICAL_SCHEDULING_ID
    : '';
  ...
  var data3 = formdataify(data2);
  const res = await request.post(
    '/DeptApplyPlan/AddNaxtDayApplyPlanMain',
    data3
  );
  if (res.data.code == 200) {
    return res.data;
...
export async function GetNaxtDayApplyPlanDel(data) {
  ...
  var data3 = formdataify(data2);
  const res = await request.post(
    '/DeptApplyPlan/GetNaxtDayApplyPlanDel',
    data3
  );
  if (res.data.code == 200) {
    return res.data;
...
export async function AddNaxtDayApplyPlanDel(data) {
  ...
  var data3 = formdataify(data2);
  const res = await request.post(
    '/DeptApplyPlan/AddNaxtDayApplyPlanDel',
    data3
  );
  if (res.data.code == 200) {
    return res.data;
...
export async function AddNaxtDayApplyPlanDelBatch(data) {
  ...
  const res = await request.post(
    '/DeptApplyPlan/AddNaxtDayApplyPlanDelBatch',
    rep
  );
  if (res.data.code == 200) {
    return res.data;
...
export async function upNaxtDayApplyPlanMainByState(data) {
  ...
  const res = await request.post(
    '/DeptApplyPlan/upNaxtDayApplyPlanMainByState',
    rep
  );
  if (res.data.code == 200) {
    return res.data;
...
export async function DeleteNaxtDayApplyPlanMain(data) {
  ...
  const res = await request.post(
    '/DeptApplyPlan/DeleteNaxtDayApplyPlanMain',
    rep
  );
  if (res.data.code == 200) {
    return res.data;
...
export async function CreatePperationExcel(data) {
  var data2 = {};
  data2.ID = data.ID ? data.ID : '';
  data2.NAXT_DAT_PLAN_NUM = data.NAXT_DAT_PLAN_NUM
    ? data.NAXT_DAT_PLAN_NUM
    : '';
