...
export async function SearchDept(data) {
    ...
    data2.THE_FIRST_BATCH_OF_KEY_CONSUMA = ''
...
export async function SearchDeptHz(data) {
    let data2 = {};
    data2.Token = sessionStorage.getItem(TOKEN_STORE_NAME);
    data2.hp = HOME_HP;
    data2.page = data.page;
    ...
    data2.deptTwoJson = data.where.DEPT_TWO_CODE ? JSON.stringify(data.where.DEPT_TWO_CODE) : ''
    data2.varietie = data.where.varietie ? data.where.varietie : ''
    data2.supplier = data.where.supplier ? data.where.supplier : ''
    data2.batch = data.where.batch ? data.where.batch : ''
    data2.deptTwoName = data.where.deptTwoName ? data.where.deptTwoName : ''
    ...
    data2.Hospitalization_Number = ''
    data2.THE_FIRST_BATCH_OF_KEY_CONSUMA = ''
    const res = await request.get('/DeptConsume/SearchDeptHz', {
        params: data2
    });
    if (res.data.code == 200) {
        return res.data;
...
export async function SearchDeptHzKs(data) {
    let data2 = {};
    data2.Token = sessionStorage.getItem(TOKEN_STORE_NAME);
    data2.hp = HOME_HP;
    data2.page = data.page;
    ...
    data2.Hospitalization_Number = ''
    data2.THE_FIRST_BATCH_OF_KEY_CONSUMA = ''
    const res = await request.get('/DeptConsume/SearchDeptHzKs', {
        params: data2
    });
    if (res.data.code == 200) {
        return res.data;
